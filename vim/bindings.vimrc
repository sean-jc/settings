...
imap <C-p>a Cc: Aaron Lewis <aaronlewis@google.com>
imap <C-p>d Cc: David Matlack <dmatlack@google.com>
imap <C-p>e Reported-by: Stefan Teodorescu <fane@google.com>
...
imap <C-p>l Cc: Tom Lendacky <thomas.lendacky@amd.com>
...
imap <C-p>z Cc: Vitaly Kuznetsov <vkuznets@redhat.com>
